...
// NewDescribe initializes a new cluster release inspect command.
func NewDescribe(config map[string]config.Cluster) types.Command {
	return &Describe{config: config}
}
